...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "U SHYAM SUJIN\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "212223040201");
  HAL_Delay(500);
  while(1){}
}
void SystemClock_Config(void)
...
## Output screen shots of proteus  :
 ...
 ![Image](https://github.com/Shyamsujin/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870449/5db711c6-773d-47c8-802c-becff4a6643c)



 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/Shyamsujin/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870449/9cacffab-8128-4707-926e-8f5e2d770520)
